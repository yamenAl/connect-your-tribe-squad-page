...
app.get('/', async function (request, response) {
  ...
  const personResponse = await fetch('https://fdnd.directus.app/items/person/?filter={"team":"Rad"}&fields=*,squads.squad_id.name,squads.squad_id.name,squads.squad_id.cohort&filter={"_and":[{"squads":{"squad_id":{"tribe":{"name":"FDND Jaar 1"}}}},{"squads":{"squad_id":{"cohort":"2425"}}}]}')
